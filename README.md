...
<ul style="list-style-position: inside; padding-left: 0; display: flex; align-items: center;">
  <li style="display: flex; align-items: center; gap: 10px;">
    <img src="https://github.com/IoGomes/IoGomes/blob/main/visualparadigm%20(1).png?raw=true" width="50" />
    <img src="https://github.com/IoGomes/IoGomes/blob/main/postman%20(1).png?raw=true" width="50" />
  </li>
</ul>
